                                ...
                                <div class="card-body">
                                    <form ng-submit="pageChanged('typeclient')">
                                        <div class="form-row animated fadeIn mt-4">
                                            ...
                                            <div class="col-md-12 form-group">
                                                <select class="form-control select2 modal search_typeprixvente required text-capitalize" id="type_prix_vente_list_typeclient" placeholder="Type de PV">
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                        @foreach($modules as $module)
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="card card-custom  gutter-b bg-gray-200 h-450px">
                                                    <div class="row">
                                                            ...
                                                            <div class="card card-custom gutter-b bg-gray-200">
                                                                <div class="card-body bg-dark-o-5 pt-10 pb-3">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-1">
                                                                            <div class="d-flex">
                                                                                     <span class="svg-icon svg-icon-xl" style="margin-top: -10px !important;">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <div class="d-flex">
                                                                            <span class="ms-5" style="margin-top: -10px !important;">
                                                                                {{$module->title}}
                                                                            </span>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-2 text-right mb-5">
                                                                            <div class="menu-leftToRight d-flex align-items-center justify-content-center">
                                                                                <input type="checkbox" href="#" class="menu-open" name="menu-open" id="menu-m-open-@{{ $module->title }}">
                                                                                <label class="menu-open-button m-0 border-0 btn btn-sm btn-icon bg-gray-100" for="menu-m-open-@{{ $module->title }}">
                                                                                ...
                                                                                <button class="menu-btn-item btn btn-sm btn-danger btn-icon font-size-sm" title="{{ __('customlang.supprimer') }}">
                                                                                    <i class="flaticon2-trash"></i>
                                                                                </button>
                                                                                <button class="menu-btn-item btn btn-sm btn-warning btn-icon font-size-sm"  title="{{ __('customlang.modifier') }}">
                                                                                    <i class="flaticon2-edit"></i>
                                                                                </button>
                                                                                <button class="menu-btn-item btn btn-sm btn-info btn-icon font-size-sm" title="{{ __('customlang.cloner') }}">
                                                    ...
                                                    <div class="card-body bg-dark-o-5 pt-10 pb-3" style="overflow:auto">
                                                        <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="card card-custom  gutter-b">
                                                                        <div class="card-body bg-dark-o-5 pt-10 pb-3">
                                                                            ...
                                                                            <div class="row" id="drag1" src="img_logo.gif" draggable="true" ondragstart="drag(event)" >

                                                                                <div class="col-md-1">
                                                                                    <div class="d-flex">
                                                                                        <span class="svg-icon" style="margin-top: -10px !important;">
                                                                                ...
                                                                                <div class="col-md-2 text-right mb-5">
                                                                                    <div class="menu-leftToRight d-flex align-items-center justify-content-center">
                                                                                        ...
                                                                                        <button class="menu-btn-item btn btn-sm btn-info btn-icon font-size-sm" ng-click="showModalUpdate('clone_produit',item.id, 'null', 'null')" title="{{ __('customlang.cloner') }}">
                                                                                            <i class="flaticon2-copy"></i>
                                                                                        </button>

                                                                                        <a target="_blank" class="menu-btn-item btn btn-sm btn-primary btn-icon font-size-sm" href="#!/detail-produit/@{{item.id}}" title="Voir les détails">
