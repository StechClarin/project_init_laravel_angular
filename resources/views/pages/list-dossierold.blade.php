                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom  gutter-b">
                        <div class="card-body bg-dark-o-5 pt-10 pb-3">
                            <div class="item-card-consultation">
                                <div class="row justify-content-between">
                                    <!--card-success , card-warning , card-danger-->
                                    <div class="animated fadeIn col-lg-6" ng-repeat="item in dataPage['dossiers']">
                                        <div class="item-card-consultation-0 mb-3" ng-class="{'card-success': item.ordre_transit.status === true, 'card-danger': item.ordre_transit.status !== true}">
                                            <div class="row m-0">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="align-self-center lh-18">
                                                            <div class="item-consultation-titre">
                                                                <div class="text-uppercase text-dark">@{{item.ordre_transit.code}}</div>
                                                ...
                                                <div class="col-4 p-lg-0 p-md-1 align-self-center">
                                                    <div class="lh-18 ellipsis-1">
                                                        <div class="item-consultation-titre item-consultation-code fw-bold">Date :  @{{item.ordre_transit.date_fr}}</div>
                                                ...
                                                <div class="row px-3 pb-2 mt-3">
                                                    <div class="col-6">
                                                        ...
                                                        <div class="item-card-consultation-detail">
                                                            <div class="d-flex">
                                                                <span class="fw-bold badge badge-warning">@{{item.ordre_transit.date_depart_fr}}</span>
                                                                <i class="fa fa-minus text-dark ms-2 me-2"></i>
                                                                <span class="fw-bold badge badge-success">@{{item.ordre_transit.date_depart_fr}}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        ...
                                                        <div class="item-card-consultation-detail">
                                                            <span class="fw-bold text-uppercase badge badge-primary">@{{item.ordre_transit.type_marchandise.nom}}</span> /
                                                            <span class="fw-bold text-uppercase badge badge-warning">@{{item.ordre_transit.type_importation.nom}}</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 mt-3">
                                                        <div class="lh-18">Marchandises</div>
                                                        <div class="item-card-consultation-detail">
                                                            <span ng-repeat="ssitem in item.ordre_transit.marchandises" class="fw-bold text-uppercase">@{{ssitem.marchandise.nom}} / </span>
                                                        </div>
                                                    </div>
