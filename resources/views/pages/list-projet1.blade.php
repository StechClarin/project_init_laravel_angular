                            ...
                            <div class="card-header p-5">
                                ...
                                <div class="m-auto d-inline-flex page-head-title">
                                    <h4 class="card-label align-self-center m-auto position-relative">
                                        {{ __('customlang.typeprojet') }}
                                        <span class="badge badge-light-primary position-absolute" style="top: -5px ; margin-left: 5px">@{{paginations['typeprojet'].totalItems | currency:"":0 | convertMontant}}</span>
                                    </h4>
                                </div>
                                    ...
                                    <div class="dropdown dropdown-inline" title="{{ __('customlang.ajouter') }}" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover">
                                        @if(auth()->user()->can('creation-typeprojet') || auth()->user()->can('modification-typeprojet'))
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-175px" data-kt-menu="true" data-kt-element="theme-mode-menu">
                                                ...
                                                @endif
                                                @if(auth()->user()->can('creation-typeprojet') || auth()->user()->can('modification-typeprojet'))
                                                    <div class="menu-item px-3 my-0" ng-click="showModalAdd('typeprojet', {is_file_excel:true, title: '{{ __('customlang.typeprojet') }}'})">
                                                        <a href="" class="menu-link px-3 py-2">
                                                            <span class="menu-icon" data-kt-element="icon">
                                                                <span class="svg-icon svg-icon-3">
                                    ...
                                    <form ng-submit="pageChanged('typeprojet')">
                                        <div class="form-row animated fadeIn mt-4">
                                            <div class="col-md-12 form-group">
                                                <input type="text" class="form-control" id="search_list_typeprojet" ng-model="search_list_typeprojet" placeholder="{{ __('customlang.rechercher_par_nom') }}" ng-model-options="{ debounce: 500 }" ng-change="pageChanged('typeprojet')">
                                            </div>
                                        </div>
                                    ...
                                    <table class="m-auto table-striped table table-head-custom table-vertical-center table-head-bg table-borderless table-report text-center">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="min-width: 120px">{{ __('customlang.nbre_projets') }}</th>
                                        ...
                                        <tbody>
                                            <tr class="" ng-repeat="item in dataPage['typeprojets']">
                                                ...
                                                <td>
                                                    <span class="text-muted fw-bold">@{{item.nbre_projet}}</span>
                                                </td>
