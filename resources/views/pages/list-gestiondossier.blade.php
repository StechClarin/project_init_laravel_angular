        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <div class="dropdown dropdown-inline" title="{{ __('customlang.ajouter') }}" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover">
                    @if(auth()->user()->can('creation-dossier') || auth()->user()->can('modification-dossier'))
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-175px" data-kt-menu="true" data-kt-element="theme-mode-menu">
                            @if(auth()->user()->can('creation-dossier'))
                                <div class="menu-item px-3 my-0" ng-click="showModalAdd('dossier')">
                            ...
                            @endif
                            @if(auth()->user()->can('creation-dossier') || auth()->user()->can('modification-dossier'))
                                <div class="menu-item px-3 my-0" ng-click="showModalAdd('dossier', {is_file_excel:true, title: 'dossier'})">
                                    <a href="" class="menu-link px-3 py-2">
                                        <span class="menu-icon" data-kt-element="icon">
                                            <span class="svg-icon svg-icon-3">
                                    ...
                                    <form ng-submit="pageChanged('dossier')">
                                        <div class="form-row row animated fadeIn mt-4 ">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <select class="select2 form-control filter" id="nomenclature_dossier_list_dossier" style="width: 100%">
                                                        <option value="">Nomenclature du dossier</option>
                                            ...
                                            <div class="col-md-12 form-group d-flex justify-content-center">
                                                <span class="me-3 fw-bolder">Activer ?</span>
                                    ...
                                    <table class="table table-head-custom table-vertical-center table-head-bg table-borderless table-report text-center">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="min-width: 120px">Type dossier</th>
                                                    ...
                                                    <td class="pr-0 text-right">
                                                        <div class="menu-leftToRight d-flex align-items-center justify-content-center">
                                                            ...
                                                            @if(auth()->user()->can('modification-dossier'))
                                                                ...
                                                                <button ng-if="!item.status" class="menu-btn-item btn btn-sm btn-light-success btn-icon font-size-sm" title="{{__('customlang.activation')}}" ng-click="showModalStatutNotif($event,'dossier', 1, item, {mode:2, title: 'Activer un dossier'})">
                                                                    <i class="fa fa-thumbs-up"></i>
                                                                </button>
                                                                <button ng-if="item.status" class="menu-btn-item btn btn-sm btn-light-danger btn-icon font-size-sm" title="{{__('customlang.desactivation')}}" ng-click="showModalStatutNotif($event,'dossier', 0, item, {mode:2, title: 'Désactiver  un dossier'})">
