    ...
    <table class="main" cellpadding="0" cellspacing="0" width="80%">
        ...
        <tbody>
            <tr class="row row-body">
                <td>
                    <h1 class="main-heading">Nouvelle opération sur le stock.</h1>
                </td>
            </tr>
            <tr class="row row-body">
                <td>
                <p>Bonjour {{ $nomValidateur ?? '' }}! </p>
                    ...
                    <p class="paragraph">
                        L'opération de stock : {{ $code ?? '' }}, vient d'etre validée.
                    </p>

                    <p>Merci de vous connecter à votre interface d'administration afin de verifier.</p>
                </td>
            </tr>
        </tbody>`
        <tfoot>
            <tr class="row row-foot">
                <td>
                    <p class="paragraph paragraph-footer">La Référence du linge de maison au Sénégal
                        ...
                        , Accueil : +221 33 842 80 82, SAV : +221 33 927 78 84
                    </p>
                </td>
            </tr>
        </tfoot>
