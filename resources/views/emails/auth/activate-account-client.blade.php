    ...
    <table class="main" cellpadding="0" cellspacing="0" width="80%">
        ...
        <tbody>
            <tr class="row row-body">
                <td>
                    <h1 class="main-heading">Activation compte.</h1>
                </td>
            </tr>
            <tr class="row row-body">
                <td>
                    <p>Monsieur/Madame {{ $nomComplet ?? '' }}</p>
                    <p class="paragraph">
                        Pour l'activation de votre compte, veuillez cliquer sur le bouton ci-dessous.
                    </p>
                </td>
            </tr>
            <tr class="row row-body">
                <td>
                    <a href="{{ route('ecommerce.activate.user', $token) }}" class="main--link btn">Activez votre compte</a>
                </td>
            </tr>
        </tbody>
        <tfoot>
